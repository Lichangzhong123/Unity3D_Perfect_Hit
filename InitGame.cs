...
public class InitGame : Controller
{
    public override void Execute(object data)
    {
       ...
       // BodyNmbView bodyNmbView = GameRootView.instance.transform.Find("Canvas/PlayerBodyNumb").GetComponent<BodyNmbView>();
        BodyNmbView bodyNmbView = GameRootView.instance.transform.Find("Game/PlayerList/Canvas/Text").GetComponent<BodyNmbView>();
        ...
        Music_ParticaleView music_ParticaleView = GameRootView.instance.transform.Find("Music_ParticleCtroll").GetComponent<Music_ParticaleView>();
        MVC.instance.RegisterView(music_ParticaleView);
